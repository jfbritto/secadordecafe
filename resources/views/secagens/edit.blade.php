...
<div class="max-w-6xl mx-auto">
    ...
    <div class="grid lg:grid-cols-2 gap-5 mb-6">
        ...
        {{-- Adicionar cliente --}}
        <form method="POST" action="{{ route('secagens.items.store', $secagem) }}" class="bg-white rounded-2xl border border-leaf-100 shadow-sm p-6">
            @csrf
            <div class="border-b border-leaf-100 pb-4 mb-5">
                <h2 class="text-base font-bold text-leaf-900">Adicionar cliente à secagem</h2>
                <p class="text-sm text-leaf-500 mt-0.5">Cada cliente entra <strong>uma vez por secagem</strong>. Pra ajustar valores, remova o item e adicione de novo.</p>
            </div>

            <div class="space-y-4">
                <div>
                    <label for="customer_id" class="block text-sm font-bold text-leaf-900 mb-2">
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-leaf-500">Café côco</p>
                    </div>
                    <div>
                        ...
                        <p class="mt-1 text-xs text-leaf-500">Pilado</p>
                    </div>
                    <div>
                        ...
                        <p class="mt-1 text-xs text-leaf-500">Sobre o seco</p>
                    </div>
                </div>
            ...
            <button class="mt-5 w-full sm:w-auto px-5 py-2.5 text-sm font-bold text-white bg-leaf-600 hover:bg-leaf-700 rounded-lg transition">+ Adicionar item</button>
        </form>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-leaf-100 shadow-sm p-6">
        <div class="flex flex-col sm:flex-row sm:items-center gap-3">
            @can('conclude', $secagem)
                ...
                <p class="text-xs text-leaf-500 sm:max-w-xs">
