...
<div class="max-w-2xl bg-white rounded-2xl border border-coffee-100 shadow-sm p-10 text-center">
    ...
    <h1 class="text-xl font-bold text-coffee-900 mb-2">Nenhum secador cadastrado</h1>
    <p class="text-sm text-coffee-500 mb-6">Cadastre pelo menos um secador antes de registrar uma secagem.</p>
    @can('create', App\Models\Dryer::class)
        <a href="{{ route('secadores.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-white bg-coffee-700 hover:bg-coffee-800 rounded-lg transition shadow-sm">
            Cadastrar secador
