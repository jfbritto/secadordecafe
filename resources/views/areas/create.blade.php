...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-sm text-leaf-500 mt-1">Cada talhão ou lote da roça. Ao criar uma secagem, você poderá vinculá-la a uma área e ter o controle de produção por região.</p>
    </div>
