...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-coffee-900">Editar área</h1>
    </div>

    <form method="POST" action="{{ route('areas.update', $area) }}" class="bg-white rounded-2xl border border-coffee-100 shadow-sm p-6 sm:p-8">
        @method('PUT')
        @include('areas._form')
        ...
        <div class="flex flex-col-reverse sm:flex-row sm:items-center gap-3 pt-6 border-t border-coffee-100">
            ...
            <a href="{{ route('areas.show', $area) }}" class="text-center sm:text-left px-4 py-3 sm:py-0 text-sm font-semibold text-coffee-600 hover:text-coffee-900">Cancelar</a>
        </div>
    </form>
