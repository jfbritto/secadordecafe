    ...
    <aside x-init="$nextTick(() => $el.classList.add('is-ready'))"
        ...
        <nav class="flex-1 p-3 space-y-0.5 overflow-y-auto">
            ...
            @if(!$isRoot)
                ...
                @php $nav('colheitas.create', 'Colheitas', 'M12 2C8 6 5 10 5 14a7 7 0 0014 0c0-4-3-8-7-12z', 'colheitas.*'); @endphp
                @php $nav('compras.index', 'Compras de café', 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z', 'compras.*'); @endphp
                @php $nav('movimentacoes.recentes', 'Movimentações', 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', 'movimentacoes.recentes'); @endphp
                @php $nav('movimentacoes.fazenda.index', 'Estoque da fazenda', 'M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z', 'movimentacoes.fazenda.*'); @endphp
