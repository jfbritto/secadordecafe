...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <p class="text-xs text-leaf-500 mb-1">
            ...
            <span class="text-leaf-700">Nova</span>
        </p>
        <h1 class="text-2xl font-bold text-leaf-900">Nova categoria de despesa</h1>
    </div>

    <form method="POST" action="{{ route('despesas.categorias.store') }}" class="bg-white rounded-2xl border border-leaf-100 shadow-sm p-6 sm:p-8">
