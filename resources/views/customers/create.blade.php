...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <p class="text-xs text-coffee-500 mb-1">
            <a href="{{ route('clientes.index') }}" class="hover:underline">Clientes</a> · <span class="text-coffee-700">Novo</span>
        </p>
        <h1 class="text-2xl font-bold text-coffee-900">Novo cliente</h1>
        <p class="text-sm text-coffee-500 mt-1">Preencha os dados do produtor. Só o nome é obrigatório.</p>
    </div>

    <form method="POST" action="{{ route('clientes.store') }}" class="bg-white rounded-2xl border border-coffee-100 shadow-sm p-6 sm:p-8">
