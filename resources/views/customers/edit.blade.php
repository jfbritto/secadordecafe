...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-leaf-900">Editar cliente</h1>
    </div>

    <form method="POST" action="{{ route('clientes.update', $customer) }}" class="bg-white rounded-2xl border border-leaf-100 shadow-sm p-6 sm:p-8">
        @method('PUT')
        ...
        <div class="mt-6 bg-white rounded-2xl border border-rose-200 shadow-sm p-6 sm:p-8">
            <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                <div class="flex-1">
                    ...
                    <p class="text-sm text-rose-600 mt-0.5">Remover este cliente das listas. As movimentações antigas continuam no histórico.</p>
                </div>
