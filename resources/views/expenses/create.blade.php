...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <p class="text-xs text-coffee-500 mb-1">
            <a href="{{ route('despesas.index') }}" class="hover:underline">Despesas</a> · <span class="text-coffee-700">Nova</span>
        </p>
        <h1 class="text-2xl font-bold text-coffee-900">Nova despesa</h1>
    </div>

    <form method="POST" action="{{ route('despesas.store') }}" class="bg-white rounded-2xl border border-coffee-100 shadow-sm p-6 sm:p-8">
