...
<div class="flex items-start justify-between mb-6 gap-4 flex-wrap">
    <div>
        <h1 class="text-2xl font-bold text-leaf-900">Painel da Plataforma</h1>
...
<div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3 mb-6">
    @php
        $rootCards = [
            ...
            ['label'=>'Em teste', 'value'=>$farmsTrial, 'tone'=>'amber'],
...
<div class="grid lg:grid-cols-2 gap-6">
    <div class="bg-white rounded-xl border border-leaf-100 shadow-sm p-6">
        ...
        <ul class="space-y-2">
            @foreach(['trial'=>'Em teste','active'=>'Ativas','partner'=>'Parceiras','past_due'=>'Em atraso','canceled'=>'Canceladas','blocked'=>'Bloqueadas'] as $st => $label)
