...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <p class="text-xs text-leaf-500 mb-1">
            <a href="{{ route('secadores.index') }}" class="hover:underline">Secadores</a> · <span class="text-leaf-700">Novo</span>
        </p>
        <h1 class="text-2xl font-bold text-leaf-900">Novo secador</h1>
        <p class="text-sm text-leaf-500 mt-1">Cadastre os equipamentos da fazenda. Você poderá selecioná-los ao criar uma secagem.</p>
    </div>

    <form method="POST" action="{{ route('secadores.store') }}" class="bg-white rounded-2xl border border-leaf-100 shadow-sm p-6 sm:p-8">
