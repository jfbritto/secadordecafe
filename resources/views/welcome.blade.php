    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            <a href="/" class="flex items-center gap-2.5">
                ...
                <span class="text-lg font-bold text-coffee-900">Roça Nossa</span>
            </a>
            <nav class="hidden md:flex items-center gap-7 text-sm font-medium text-coffee-600">
                <a href="#features" class="hover:text-coffee-900 transition">O que faz</a>
                ...
                <a href="#faq" class="hover:text-coffee-900 transition">Dúvidas</a>
            </nav>
            <div class="flex items-center gap-2">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="px-4 py-2 text-sm font-semibold text-white bg-coffee-700 hover:bg-coffee-800 rounded-lg transition shadow-sm shadow-coffee-700/20">Criar minha roça</a>
                @endauth
            </div>
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.05] tracking-tight mb-6">
                    A roça é nossa.
                    <span class="bg-gradient-to-r from-coffee-700 to-amber-700 bg-clip-text text-transparent">O controle também.</span>
                </h1>
                ...
                <p class="mt-4 text-xs text-coffee-500">Sem cartão de crédito no teste. Cancele quando quiser.</p>
            </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-lg font-bold text-coffee-900">15/05/2026 · Secador 1</p>
                            </div>
...
<section id="features" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <p class="text-sm font-semibold text-coffee-700 uppercase tracking-wider mb-2">O que faz</p>
            <h2 class="text-3xl sm:text-4xl font-extrabold text-coffee-900 mb-4">Tudo o que sua roça precisa</h2>
            <p class="text-lg text-coffee-500 max-w-2xl mx-auto">A Roça Nossa começou no café e cresce com você. Substitui caderno, planilha e WhatsApp num lugar só.</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            @php
                $features = [
                    ...
                    ['title'=>'Secagem multi-produtor', 'desc'=>'Uma secagem com vários da turma. Recebido, seco, comissão e líquido por linha — totalizado automaticamente. Chega de pegar no lápis.', 'icon'=>'M5 8h14M5 12h14M5 16h14M4 4h16a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V5a1 1 0 011-1z', 'color'=>'amber'],
...
<section id="como-funciona" class="py-24 bg-coffee-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <h2 class="text-3xl sm:text-4xl font-extrabold text-coffee-900 mb-4">Da inscrição à primeira secagem em 5 minutos</h2>
        </div>
...
<section id="planos" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl sm:text-4xl font-extrabold text-coffee-900 mb-4">Comece grátis. Pague conforme a roça cresce.</h2>
            <p class="text-lg text-coffee-500 max-w-2xl mx-auto">14 dias de teste em qualquer plano. Mensal, cancele quando quiser.</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            @foreach($plans as $p)
                <div class="rounded-2xl border {{ $p['featured'] ? 'border-coffee-700 shadow-2xl shadow-coffee-700/15 ring-2 ring-coffee-700' : 'border-coffee-100 shadow-sm' }} bg-white p-7 relative">
                    @if($p['featured'])
                        <span class="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-coffee-700 text-white text-[10px] font-bold uppercase tracking-wider">Mais escolhido</span>
                    @endif
                    ...
                    <a href="{{ $p['name'] === 'Cooperativa' ? 'mailto:contato@rocanossa.com.br' : route('register') }}" class="block w-full text-center px-4 py-3 text-sm font-semibold rounded-xl transition {{ $p['featured'] ? 'text-white bg-coffee-700 hover:bg-coffee-800 shadow-md shadow-coffee-700/20' : 'text-coffee-700 bg-coffee-50 hover:bg-coffee-100' }}">
                        {{ $p['cta'] }}
                    </a>
                </div>
            @endforeach
...
<section id="faq" class="py-24 bg-coffee-50">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <p class="text-sm font-semibold text-coffee-700 uppercase tracking-wider mb-2">Dúvidas</p>
            <h2 class="text-3xl sm:text-4xl font-extrabold text-coffee-900">Perguntas que sempre chegam</h2>
        </div>
        <div class="space-y-3">
            @foreach([
...
<section class="py-20 bg-gradient-to-br from-coffee-700 to-coffee-900 relative overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        <p class="text-coffee-200 text-lg max-w-xl mx-auto mb-8">14 dias grátis pra você botar pra rodar. Sem cartão, sem complicação.</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8 mb-8">
            <div>
                ...
                <p class="text-sm text-coffee-300">A tecnologia que entende a roça.</p>
            </div>
            <div>
