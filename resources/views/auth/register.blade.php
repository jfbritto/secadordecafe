...
<div class="bg-white rounded-2xl shadow-xl shadow-coffee-700/5 border border-coffee-100 p-6 sm:p-8">
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5" novalidate>
        ...
        <div>
            <label for="farm_name" class="block text-sm font-bold text-coffee-900 mb-2">
            ...
            <p class="mt-1.5 text-xs text-coffee-500">Como sua fazenda aparecerá no sistema.</p>
        ...
        <div>
            ...
            <input id="email" name="email" type="email" value="{{ old('email') }}" required
                   ...
                   class="w-full px-4 py-3 text-base rounded-lg border border-coffee-200 placeholder-coffee-300 focus:border-coffee-500 focus:ring-4 focus:ring-coffee-500/15 outline-none transition">
            <p class="mt-1.5 text-xs text-coffee-500">Você usa este e-mail para entrar e receber notificações.</p>
    ...
    <p class="text-center text-sm text-coffee-500 mt-6">
        Já tem conta? <a href="{{ route('login') }}" class="text-coffee-700 font-bold hover:underline">Entrar</a>
    </p>
</div>
@endsection
